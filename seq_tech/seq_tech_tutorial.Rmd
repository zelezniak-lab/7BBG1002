...
We now build a genome index (don't worry, you will learn what it is), but lets take a look at the Varicella genome


```{r varicella_genome, eval=FALSE}
library(geneviewer)
...
htmlwidgets::saveWidget(w, file = "figures/varicella_genome_GC.html", selfcontained = TRUE)
